      ...
      <RadioGroup.Option
        ...
        className={({ active, checked }) =>
          cn(
            ...
            active || checked ? `border-${color.tw}` : 'border-transparent'
          )
        }
      >
        <span
          className={cn(
            `h-8 w-8 rounded-full border border-black border-opacity-10`,
            {
              ...
              'bg-red-500': color.tw === 'red-500',
              'bg-green-500': color.tw === 'green-500',
              'bg-purple-500': color.tw === 'purple-500',
              'bg-yellow-500': color.tw === 'yellow-500',
            }
          )}
        />
      </RadioGroup.Option>
